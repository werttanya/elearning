...
jQuery(function ($) {
    ...
    $("#newQuizForm").on("click", "#addAnswerBtn", function (e) {
        ...
        $(nextAnswer).children(":input").attr("placeholder", "Answer " + answerNumber).attr("name", "answer" + answerNumber).val("");
    ...
    $("#addQuestionBtn").click(function (e) {
        ...
        secondChild.children("#question1Answer1").attr("id", "question" + questionNumber + "Answer1");
